...
This repository is a **submodule of [TMT](https://github.com/ovitente/tmt)**. It lives at `tools/theme-changer/` in the parent repo. See `CLAUDE.md` and `lat.md/` for details.
